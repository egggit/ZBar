                                   ...
                                   zbar_image_t *img)
{
    ...
    // modified by egg, force sjis to recognize as BIG-5,
    // Since there are quite few times that big5 would be incorrectly read into japanese.
//    sjis_cd=iconv_open("UTF-8","SJIS");
    sjis_cd=iconv_open("UTF-8","BIG-5");
